...
/*------------------------------------------------C A M P U S------------------------------------------------*/
	...
	public function get_searchCampus(Request $request)
	{
	...
	public function get_searchTipo(Request $request)
	{
...
/*-------------------------------------------- C U R S O S -------------------------------------------------------*/
	public function get_select()
	{
		...
		$carrera = Carrera::paginate()->lists('nombre','id');
...
/*--------------------------------------------D E P A R T A M E N T O S--------------------------------------*/
	...
	public function get_createDepartamento()
	{
		...
		$facultades = Facultade::paginate()->lists('nombre','id');
	...
	public function get_searchDepto(Request $request)
		{
	...
	public function get_searchEscuela(Request $request)
		{
	...
	public function get_editFacultad(Requests\EditFacultadRequest $request)
	{
	...
	public function post_uploadFacultades(Request $request)
		...
		public function get_searchFacultad(Request $request)
		{
	...
	public function get_searchFuncionario(Request $request)
		{
	...
	public function post_uploadRoles(Request $request)
	{
		...
		public function get_searchRol(Request $request)
		{
...
public function get_usuarios()
{
	...
	return view('Administrador/roles_usuarios/rolesUsuario_list',compact('datos_roles'));
}


	public function get_searchRolUsuario(Request $request)
	{
		...
		else
		{
	 	...
	 	return redirect()->action('AdministradorController@get_usuarios');
