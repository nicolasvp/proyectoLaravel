...
<div class="bs-docs-section">                
 <div class="panel panel-default">
   <div class="panel-body">
       ...
       {!! Form::open(['action' => ['EncargadoController@get_searchEstudiante'], 'method' => 'GET','class' => 'navbar-form navbar-left pull-right','role' => 'search']) !!}
            <div class="form-group">
          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                  ...
                  {!! Form::open(['action' => ['EncargadoController@get_editEstudiante'], 'method' => 'GET']) !!}
              ...
              <td>
                  {!! Form::open(['action' => ['EncargadoController@delete_destroyEstudiante'], 'method' => 'DELETE']) !!}
                  {!! Form::hidden('id', $estudiante->id)!!}
