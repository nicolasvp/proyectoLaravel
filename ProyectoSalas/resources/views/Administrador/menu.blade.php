      ...
      <tr> 
         <th>       
          ...
          <th>     
            ...
            {!! Form::select('perfil', $var,'administrador',['class' => 'form-control']) !!}
              </div>      
          </th>
...
<div class="col-sm-3">
  ...
  <div class="sidebar-nav navbar-collapse" style="margin-top: 15px">
      ...
      <ul class="list-group" id="side-menu">
            ...
            <li class="list-group-item"><a href="{{URL::to('/administrador/horarios')}}"><i class="glyphicon glyphicon-menu-right" aria-hidden="true"></i>Horarios</a></li>
