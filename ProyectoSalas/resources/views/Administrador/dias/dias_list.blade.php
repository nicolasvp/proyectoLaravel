...
@section('sideBar')
   ...
   <p> <h2>Lista de dias</h2></p>
         ...
         <p>
                         {!! Form::open(['action' => 'AdministradorController@get_createDia', 'method' => 'GET']) !!}
          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                  ...
                  {!! Form::open(['action' => ['AdministradorController@get_editDia'], 'method' => 'GET']) !!}
              ...
              <td>
                  {!! Form::open(['action' => ['AdministradorController@delete_destroyDia'], 'method' => 'DELETE']) !!}
                  {!! Form::hidden('id', $dia->id)!!}
