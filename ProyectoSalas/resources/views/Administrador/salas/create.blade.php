  ...
  <div class="panel-body">                  
   ...
   <div class="row">
         ...
         <div class="col-sm-9" >
          ...
          <p>
                         {!! Form::open(['action' => 'Administrador\SalaController@get_upload', 'method' => 'GET']) !!}
 ...
 <div class="panel panel-default">
   <div class="panel-body">
    ...
    @include('Administrador/messages')
      ...
      {!! Form::open(['action' => ['Administrador\SalaController@post_store'], 'method' => 'POST']) !!}


        <div class="form-group">
         {!! Form::label('campus', 'Campus') !!}
       {!! Form::select('campus', (['0' => '-- Seleccionar un campus --'] +$campus), null, ['class' => 'form-control'])!!}
      </div>


      <div class="form-group">
         {!! Form::label('tipo', 'Tipo') !!}
       {!! Form::select('tipo_sala', (['0' => '-- Seleccionar un tipo --'] +$tipos_salas), null, ['class' => 'form-control'])!!}
      </div>
